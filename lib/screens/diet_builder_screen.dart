        ...
        children: [
          Row(
            ...
            children: [
              ...
              TextButton.icon(
                onPressed: onAdd,
                icon: Icon(Icons.add, size: 14, color: AppColors.gold),
                label: Text(
                  'Add',
                  style: TextStyle(
                    color: AppColors.gold,
