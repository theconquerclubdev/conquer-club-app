...
class _MemberPaymentSheetState extends State<MemberPaymentSheet> {
  ...
  Future<void> _processPayment() async {
    ...
    try {
      ...
      // Record the attempt as PENDING — membership is NOT renewed here.
      // Admin must verify the payment actually arrived and confirm it
      // (via Admin > Members > mark payment complete) before the
      // membership_end_date gets extended.
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
              'Complete the payment in your UPI app. Your membership will be renewed once admin confirms the payment.',
            ),
